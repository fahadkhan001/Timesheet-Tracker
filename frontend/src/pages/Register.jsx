  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (err.message && err.message.includes("Unexpected token")) {
        setError("Server Error: Check API URL configuration.");
      } else {
            ...
            >
              <Box
                sx={{
                  ...
                  height: "6px",
                  background:
                    "linear-gradient(90deg, #FFC107 0%, #FF8F00 100%)",
                }}
              />
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 4 }}>
                Join us to manage your workspace
              </Typography>
              ...
              >
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                        <PersonIcon
                          color={fieldErrors.name ? "error" : "action"}
                        />
                      </InputAdornment>
                    ),
                  }}
                ...
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                        <KeyIcon
                          color={fieldErrors.password ? "error" : "action"}
                        />
                      </InputAdornment>
                    ),
                    endAdornment: (
                ...
                <Button
                  ...
                  sx={{
                    ...
                    borderRadius: 2,
                    background:
                      "linear-gradient(45deg, #FFC107 30%, #FFB300 90%)",
                    boxShadow: "0 4px 14px 0 rgba(255, 193, 7, 0.39)",
                    transition: "all 0.3s ease-in-out",
                    "&:hover": {
                      background:
                        "linear-gradient(45deg, #FFB300 30%, #FFA000 90%)",
